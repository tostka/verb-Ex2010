...
Twitter     :	@tostka
CreatedDate : 1/16.4.10
FileName    : VERB-Ex2010.psm1
License     : MIT
Copyright   : (c) 1/16.4.10 Todd Kadrie
...
# 12:02 PM 5/6.4.19 added cx10,rx10,dx10 aliases
# 11:29 AM 5/6.4.19 load-EMSLatest: spliced in from tsksid-incl-ServerApp.ps1, purging ; alias Add-EMSRemote-> Connect-Ex2010 ; toggle-ForestView():moved from tsksid-incl-ServerApp.ps1
    ...
    * 2021-Nov-9 tSC's posted vers at https://thesysadminchannel.com
    ...
    BEGIN {
        ...
        $BuildToProductName = @{
            ...
            '14.0.6.4.1' = 	'Update Rollup 3 for Exchange Server 2010'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUW+5pxkv6pkuTOFHhqHr0aHTQ
# bVKgggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRCqJ7H
# 2RxbWMGafuZszaHh4iovsTANBgkqhkiG9w0BAQEFAASBgFokOj25YfSXhoj6iM2m
# TCW+xa6fdV5W6RM92AczZ5Oq2THK0IcgJD3eHxyOgJOuGjSOo9QjvSvBZbmWR8fj
# Qj46FhHah2nuN8IgzGjg7K2gQEtcRNMpP66gqAHH7ODInBxIAJRyLhdGXrq8tokF
# A/35csX23aHc+aHu5ogU93AS
